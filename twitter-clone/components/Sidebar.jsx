      ...
      <aside className="fixed top-0 left-36 h-screen w-[300px] bg-[#0a0a0a] border-r border-zinc-800 text-white flex flex-col items-start p-6 space-y-4 shadow-lg">
        ...
        <div className="relative w-full mt-auto">
          <div
            ...
            className="flex items-center space-x-3 p-2 hover:bg-gray-900 rounded cursor-pointer transition-colors"
          >
          ...
          {openMenu && (
            <div className="absolute bottom-14 left-0 w-48 bg-[#111] border border-gray-800 rounded-lg shadow-lg z-50">
              
              <Link
                href="/profile"
                className="block px-4 py-2 hover:bg-gray-900 text-sm"
              ...
              <button
                ...
                className="block w-full text-left px-4 py-2 hover:bg-gray-900 text-sm text-red-400"
              >
                Log out
              </button>
