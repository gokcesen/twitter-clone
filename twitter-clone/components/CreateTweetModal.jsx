  ...
  return (
    <div className="fixed inset-0 bg-[#0a0a0a] bg-opacity-50 flex justify-center items-start pt-24 z-50">
      <div className="bg-[#0a0a0a] rounded-xl w-full max-w-lg p-6 shadow-lg relative border border-zinc-500">
        ...
        {/* Reply option */}
        <div className="mb-4">
          <label className="text-gray-400 text-sm mb-1 block">Who can reply?</label>
          <select
            value={replyOption}
        ...
        {/* Character count */}
        <p className="text-gray-500 text-sm mb-4 text-right">{tweetText.length} / 280</p>
        ...
        <div className="flex justify-end gap-4">
          ...
          <button
            ...
            className={`py-2 px-4 rounded font-bold text-white ${
              tweetText.trim() ? "bg-blue-600 hover:bg-blue-700" : "bg-blue-900 cursor-not-allowed"
            }`}
          >
            Post
          </button>
